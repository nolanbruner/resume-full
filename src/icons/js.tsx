...
const js = (props: svg.SVGProps) => {
    ...
    return (
        <a href="https://en.wikipedia.org/wiki/JavaScript"><svg.SVG className={className} p="5px" width={props.width} height={props.height} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" {...rest}>
