...
const phone = (props: svg.SVGProps) => {
    ...
    return (
        <svg.SVG className={className} width={props.width} height={props.height} viewBox="0 0 53.942 53.942" xmlns="http://www.w3.org/2000/svg" {...rest}>
            <g>
                <g>
